 ...
 * @author samsung
 */
public class fillGaps extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //check starts
        System.out.println("hahahahaha in flllgaps servlet\n"); 
        ...
        System.out.println(Question+Answer+marks);
        //int r=Integer.parseInt(marks);
        
        //int a=db.getQuestionID();
            int a=db.getQuestionID();
            db.createQuestion(a, Question,Integer.parseInt(marks),chapterId);
            db.createFillGaps(a, Answer);
