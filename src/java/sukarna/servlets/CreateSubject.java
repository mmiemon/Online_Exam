 ...
 * @author Tanveer
 */
@WebServlet(name = "CreateSubject", urlPatterns = {"/CreateSubject"})
public class CreateSubject extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int count = db.createSubject(subjectName,className);
         Boolean result;
        if(count==1)
        {
             result=true;
        ...
        session.setAttribute("createSubjectResult", result);
