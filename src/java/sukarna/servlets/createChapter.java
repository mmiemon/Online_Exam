...
public class createChapter extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        RequestDispatcher rd = request.getRequestDispatcher("createChapter.jsp");
        String Subject = request.getParameter("Subject");
        String chapter = request.getParameter("chapter");
        int subjectId=dao.getSubjectId(Subject);
        int count=dao.createChapter(chapter, subjectId);
        ...
        session.setAttribute("createChapterResult", result);
